...
export function useMotoGPData(
    ...
    useEffect(()=> {
        (async () => {
            ...
            // 2) fetch team configs
            const teamSnap = await getDocs(collection(db, 'seasons', seasonYear, 'teamsConfigs'));
    ...
    const enriched = useMemo<Rider[]>(() => {
        // computer totalPoints for each rider
        ...
        // assign champtionship positions
